        ...
        <div class="row my-5">
            <div class="col-3">
                <ul class="d-flex flex-column navbar-aside list-unstyled">
                    ...
                    <li>
                        <a href="#cicd" class="text-black text-decoration-none">CI/CD</a>
                    </li>
                    <li>
                        <a href="#cicd-github" class="text-black text-decoration-none">GitHub</a>
                    </li>
                    <li>
                        <a href="#cicd-gitlab" class="text-black text-decoration-none">GitLab</a>
                    </li>
                </ul>
            </div>
            <div class="col">
                <h2 id="cicd" class="fw-semi-bold display-5 mb-4">CI/CD</h2>
                <p class="lead">
                ...
                <div class="d-flex flex-row my-5" id="cicd-github">
                    <div class="me-5">
                        <img src="{{ asset('storage/github.svg') }}" alt="" style="width: 59px">
                    </div>
                    <div>
                ...
                <div class="d-flex flex-row my-5" id="cicd-gitlab">
                    <div class="me-5">
                        <img src="{{ asset('storage/gitlab.svg') }}" alt="" style="width: 59px">
                    </div>
                    <div>
